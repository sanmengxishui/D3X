...
namespace JPTCG.Motion
{
    ...
    public class DeltaMotionMgr
    {
        ...
        //string motionSetFileName = "param-j.xml";
        int motionCmdDly = 100;
        static bool isOnline = false;
        List<ushort> CardNo = new List<ushort>();
        private static DeltaMotionMgr h_motion;

        public static DeltaMotionMgr CreateMotion(bool IsMchOnline)//20171216
        {
        ...
        //public bool IsBusy(ushort NodeID)//20171218
        //{
        //    //short rc = CPCI_DMC.CS_DMC_01_motion_status(CardNo[0], NodeID, 0, ref MC_status);
        ...
        {
            //WinMotionSettings myWin = new WinMotionSettings(this);//20171216
            //myWin.ShowDialog();
        }
