...
namespace PCI_DMC
{
    public class CPCI_DMC
    {
        ...
        //I16 _stdcall _misc_app_get_spiral_endpoint(int start_X, int start_Y, int center_X, int center_Y, int spiral_interval, int spiral_angle, int* end_x, int* end_y);
        ...
        //I16 _stdcall _DMC_01_04pi_md1_get_mc_error_code(ushort CardNo, ushort NodeID, ushort SlotID, ushort *error_code);
   ...
   //PCI_DMC_B02
    ...
    public static extern short CS_DMC_B02_gpio_software_control_status(ushort nCardNo, ref ushort nStatus);

	[DllImport("PCI_DMC.dll", EntryPoint ="_DMC_B02_gpio_software_control_setting")]
        public static extern short CS_DMC_B02_gpio_software_control_setting(ushort nCardNo, ushort nSetting);
	...
	[DllImport("PCI_DMC.dll", EntryPoint ="_DMC_B02_ipcmp_initial")]
        ...
        public static extern short CS_DMC_B02_tpcmp_software_trigger_level(ushort nCardNo, byte nFifoIndex, byte bActive);
