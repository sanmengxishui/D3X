...
namespace JPTCG.Motion
{
    public partial class IOInterface : UserControl
    {
        ...
        public MotionManager myMgr;//20171216
        public IOInterface(MotionManager myMotion, Panel parentPnl)
        {
            InitializeComponent();
            myMgr = myMotion;
        ...
        {
            //Output
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.LampGreen))//20171216
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.LampAmber))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.LampRed))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.Buzzer))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI1Vac1))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI1Vac2))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI2Vac1))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI2Vac2))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI3Vac1))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI3Vac2))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI4Vac1))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI4Vac2))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.Cam1Light))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.Cam2Light))
            {
            ...
            if (myMgr.ReadIOOut(1,(ushort)OutputIOlist.SpectrumLS))
            {
            ...
            if (myMgr.ReadIOOut(0,(ushort)OutputIOlist.MchLight))
            {
            ...
            //Input
            if (myMgr.ReadIOIn(1,(ushort)InputIOlist.BtnLeft))
            {
            ...
            if (myMgr.ReadIOIn(1,(ushort)InputIOlist.BtnRight))
            {
            ...
            if (myMgr.ReadIOIn(1,(ushort)InputIOlist.BtnStop))
            {
            ...
            if (myMgr.ReadIOIn(1,(ushort)InputIOlist.BtnHome))
            {
            ...
            if (myMgr.ReadIOIn(1,(ushort)InputIOlist.BtnEMO))
            { 
            ...
            if (myMgr.ReadIOIn(1,(ushort)InputIOlist.AirPressure))
            {
        ...
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.LampGreen);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.LampGreen, !val);
        }

        private void AmberLampBtn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.LampAmber);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.LampAmber, !val);
        }

        private void RedLampBtn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.LampRed);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.LampRed, !val);
        }

        private void buzzerBtn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.Buzzer);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.Buzzer, !val);
        }

        private void RI1Vac1Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI1Vac1);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI1Vac1, !val);
        }

        private void RI1Vac2Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI1Vac2);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI1Vac2, !val);
        }

        private void RI2Vac1Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI2Vac1);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI2Vac1, !val);
        }

        private void RI2Vac2Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI2Vac2);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI2Vac2, !val);
        }

        private void RI3Vac1Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI3Vac1);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI3Vac1, !val);
        }

        private void RI3Vac2Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI3Vac2);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI3Vac2, !val);
        }

        private void RI4Vac1Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI4Vac1);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI4Vac1, !val);
        }

        private void RI4Vac2Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.RI4Vac2);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.RI4Vac2, !val);
        }
        ...
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.Cam1Light);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam1Light, !val);
        }

        private void CamL2Btn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.Cam2Light);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam2Light, !val);
        }

        private void SpectLSBtn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(1,(ushort)OutputIOlist.SpectrumLS);
            myMgr.WriteIOOut(1,(ushort)OutputIOlist.SpectrumLS, !val);
        }

        private void machLightBtn_Click(object sender, EventArgs e)
        {
            bool val = myMgr.ReadIOOut(0,(ushort)OutputIOlist.MchLight);
            myMgr.WriteIOOut(0,(ushort)OutputIOlist.MchLight, !val);  
        }
