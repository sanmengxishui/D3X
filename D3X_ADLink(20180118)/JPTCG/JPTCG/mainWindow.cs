...
using JPTCG.HeightSensor;
using JPTCG.LightTiming;
...
namespace JPTCG
{
    public partial class mainWin : Form
    {
        ...
        public MotionManager motionMgr;//20171216
        ...
        public HeightSensorMgr HsMgr;//20180103
        ...
        public LampLDLS LDLS1;//20171225
        ...
        public mainWin()
        {
            ...
            motionMgr = new MotionManager(MotionType.Adlink, Para.MachineOnline, typeof(Axislist));//20171216
            ...
            HsMgr = new HeightSensorMgr();//20180103
            HsMgr.AddHeightsensor("Module1");
            HsMgr.AddHeightsensor("Module2");
            ...
            LDLS1 = new LampLDLS("LightSource");//20171225
        ...
        private void mainWin_Load(object sender, EventArgs e)
        {
            ...
            HsMgr.LoadSettings(mchSettingsFilePath);//20180103
            LDLS1.LoadSettings(mchSettingsFilePath);//20171225
            ...
            if (!motionMgr.ReadIOIn(1,(ushort)InputIOlist.BtnEMO))
            {
            ...
            motionMgr.SetServoON((int)Axislist.Mod1XAxis, true);//20171216
            motionMgr.SetServoON((int)Axislist.Mod2XAxis, true);
            motionMgr.SetServoON((int)Axislist.Mod1YAxis, true);
            motionMgr.SetServoON((int)Axislist.Mod2YAxis, true);
            motionMgr.WriteIOOut(1, (int)OutputIOlist.RotaryEnabled, true);
            SeqMgr.StartHoming();
            //motionMgr.InitRM32NT();//20171216
        ...
        public void SetUIAccess(int accesslvl)
        {
            ...
            checkBox8.Enabled = true;//20171223
            ...
            BWsaveCB.Visible = true;
            BlackErosion.Visible = true;
            WhiteErosion.Visible = true;
        ...
        private void mainWin_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            motionMgr.ResetIO();
            //motionMgr.resetRM32NT();//20171216
            motionMgr.InitRM32NT(0);//20171216
        }
        ...
        public void UpdateMod1TestResult(int Mod1Res, int indexEandC)
        {
            Action ac = new Action(() =>
            {
                if (Mod1Res == 0)
                {
                    ...
                    //motionMgr.WriteIOOut(0, 13, true);
                    //motionMgr.WriteIOOut(0, 14, true);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 15, true);//20171220 green
                    motionMgr.WriteIOOut(0, 16, true);                          
                    Thread.Sleep(500);
                    //motionMgr.WriteIOOut(0, 13, false);
                    //motionMgr.WriteIOOut(0, 14, true);
                    motionMgr.WriteIOOut(0, 15, false);
                    motionMgr.WriteIOOut(0, 16, true);    
                    ...
                    //Thread.Sleep(500);
                    //motionMgr.writeLightIO(2, false);//20171216
                    //motionMgr.writeLightIO(3, true);                   
                    //motionMgr.writeLightIO(11, false);//20171216
                    //motionMgr.writeLightIO(12, true);                  
                }
                else if (Mod1Res == -1)
                {
                    ...
                    //}
                    //motionMgr.WriteIOOut(0, 13, false);
                    //motionMgr.WriteIOOut(0, 14, false);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 15, false);//20171220 
                    motionMgr.WriteIOOut(0, 16, false);
                ...
                else
                {
                    ...
                    //motionMgr.WriteIOOut(0, 14, true);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 15, true);
                    motionMgr.WriteIOOut(0, 16, true);
                    Thread.Sleep(500);
                    //motionMgr.WriteIOOut(0, 13, false);
                    //motionMgr.WriteIOOut(0, 14, false);
        ...
        public void UpdateMod2TestResult(int Mod2Res, int indexEandC)
        {
            Action ac = new Action(() =>
            {
                if (Mod2Res == 0)
                {
                    ...
                    //motionMgr.WriteIOOut(0, 14, true);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 17, true);
                    motionMgr.WriteIOOut(0, 18, true);
                    Thread.Sleep(500);
                    //motionMgr.WriteIOOut(0, 13, false);
                    //motionMgr.WriteIOOut(0, 14, true);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 17, false);//20171220  green
                    motionMgr.WriteIOOut(0, 18, true);

                    //motionMgr.writeLightIO(4, true);//20171216
                ...
                else if (Mod2Res == -1)
                {
                    ...
                    //}
                    //motionMgr.WriteIOOut(0, 13, false);//20171220  
                    //motionMgr.WriteIOOut(0, 14, false);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 17, false);//20171220  
                    motionMgr.WriteIOOut(0, 18, false);
                ...
                else
                {
                    ...
                    //motionMgr.WriteIOOut(0, 14, false);
                    //Thread.Sleep(100);
                    motionMgr.WriteIOOut(0, 17, true);//20171220  red
                    motionMgr.WriteIOOut(0, 18, false);
        ...
        {
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampGreen, true);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampAmber, false);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampRed, false);
            UpdateStatusLbl(Color.Lime);
        }

        private void StoppingLight()
        {
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampGreen, false);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampAmber, true);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampRed, false);
            UpdateStatusLbl(Color.Orange);
        }
        ...
        private void ErrorLight()
        {
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampGreen, false);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampAmber, false);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.LampRed, true);
        ...
        private void RotIOTimer_Tick(object sender, EventArgs e)
        {
            ...
            //Output
            if (motionMgr.ReadIOOut(1,(ushort)OutputIOlist.RotaryEnabled))
            {
            ...
            //input
            if (motionMgr.ReadIOIn(1,(ushort)InputIOlist.RotaryOrigin))
            {
            ...
            if (motionMgr.ReadIOIn(1,(ushort)InputIOlist.RotaryMotionDone))
            {
            ...
            if (!motionMgr.ReadIOIn(1,(ushort)InputIOlist.RotaryError))
            {
        ...
        {
            bool val = motionMgr.ReadIOOut(1,(ushort)OutputIOlist.RotaryEnabled);
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RotaryEnabled, !val);
        }

        private void RotaryIndexBtn_Click(object sender, EventArgs e)
        {
            if ((!motionMgr.ReadIOIn(1,(ushort)InputIOlist.SafetySensor)) && (!motionMgr.ReadIOIn(1,(ushort)InputIOlist.BtnStop)))
            {
                if (Para.DisableSafeDoor)
                    RotMgr.IndexRotaryMotion();
                else
                {
                    if (motionMgr.ReadIOIn(1,(ushort)InputIOlist.DoorSensor))
                        RotMgr.IndexRotaryMotion();
                    else
                    {
        ...
        private void safetyTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (motionMgr.ReadIOIn(1,(ushort)InputIOlist.BtnStop))
            {
                SeqMgr.StopAuto();
                UIStopClicked();
            ...
            {
                //int tpTime = Para.myMain.LDLS1.ReadLight();
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            ...
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam1Light, true);
            exp.Clear();
            mean.Clear();
            ...
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam1Light, false);
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            Initsetexp2LV();
            int minExp = 0, maxExp = 0, meanExp = 0;
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam2Light, true);
            exp1.Clear();
            mean1.Clear();
            for (int i = 700; i >= 35; i -= 35)
            {
            ...
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam2Light, false);
        ...
        private void label42_Click(object sender, EventArgs e)
        {
            ...
            //myWin.ShowDialog();
            WinHeightSensor myWin = new WinHeightSensor(HsMgr);//20180103
            myWin.ShowDialog();
        }
        ...
        private void buttonAuditBox_Click(object sender, EventArgs e)
        {
            ...
            {
                motionMgr.MoveTo((ushort)Axislist.Mod1ZAxis, Para.Module[0].TeachPos[0].Z-5);
                motionMgr.MoveTo((ushort)Axislist.Mod2ZAxis, Para.Module[1].TeachPos[0].Z-5);
                ...
                myWin.ShowDialog();
                motionMgr.MoveTo((ushort)Axislist.Mod1ZAxis, Para.Module[0].TeachPos[0].Z);
        ...
        {
            WinLightTiming mywin = new WinLightTiming();
            mywin.ShowDialog();
        }
        //}
    }
