...
namespace JPTCG.Spectrometer
{
    ...
    {
        SpectManager myMgr;
        //DeltaMotionMgr mtMgr;//20171216
        MotionManager mtMgr;//20171216
        ...
        public WinSpectrometer(SpectManager MgrObj, MotionManager myMotion)
        {
            InitializeComponent();
            myMgr = MgrObj;
            mtMgr = myMotion;
        ...
        private void DarkRefBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                mtMgr.WriteIOOut(1,(ushort)OutputIOlist.SpectrumLS, false);
            }
            else
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Para.isOutShutter)
            {
                mtMgr.WriteIOOut(1,(ushort)OutputIOlist.SpectrumLS, true);
                Thread.Sleep(1000);
            }
            else
            {
