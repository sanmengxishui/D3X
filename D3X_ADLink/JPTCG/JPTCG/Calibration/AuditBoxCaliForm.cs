...
namespace JPTCG.Calibration
{
    public partial class AuditBoxForm : Form
    {
        ...
        MotionManager motionMgr;//20171216
        ...
        public AuditBoxForm(SpectManager MySpecMgr, MotionManager MyMotionMgr)
        {
            InitializeComponent();
            specMgr = MySpecMgr;
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI1Vac1, true);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI1Vac2, true);
                    Thread.Sleep(100);
                    break;
                case 1:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI2Vac1, true);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI2Vac2, true);
                    Thread.Sleep(100);
                    break;
                case 2:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI3Vac1, true);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI3Vac2, true);
                    Thread.Sleep(100);
                    break;
                case 3:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI4Vac1, true);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI4Vac2, true);
                    Thread.Sleep(100);
                    break;
            }
            ...
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.SpectrumLS, false);
            ...
            {
                case 0:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI1Vac1, false);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI1Vac2, false);
                    Thread.Sleep(100);
                    break;
                case 1:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI2Vac1, false);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI2Vac2, false);
                    Thread.Sleep(100);
                    break;
                case 2:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI3Vac1, false);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI3Vac2, false);
                    Thread.Sleep(100);
                    break;
                case 3:
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI4Vac1, false);
                    motionMgr.WriteIOOut(1,(ushort)OutputIOlist.RI4Vac2, false);
                    Thread.Sleep(100);
                    break;
            }
        ...
        {
            Para.myMain.motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam1Light, true);
            Thread.Sleep(1000);
            ...
            for (int c = 0; c < 3; c++)
            {
                ...
                if (!GrabPass)
                {
                    Para.myMain.motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam1Light, false);
                    Thread.Sleep(200);
                    return false;
                }
        ...
        {
            Para.myMain.motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam2Light, true);
            Thread.Sleep(1000);
            ...
            for (int c = 0; c < 3; c++)
            {
                ...
                if (!GrabPass)
                {
                    Para.myMain.motionMgr.WriteIOOut(1,(ushort)OutputIOlist.Cam2Light, false);
                    Thread.Sleep(200);
                    return false;
                }
        ...
        {
            if (motionMgr.ReadIOOut(1,(ushort)OutputIOlist.SpectrumLS))
            {
                motionMgr.WriteIOOut(1,(ushort)OutputIOlist.SpectrumLS, false);
                Thread.Sleep(1500);
            }
            ...
            motionMgr.WriteIOOut(1,(ushort)OutputIOlist.SpectrumLS, true);
        ...
        private void InitZAxis()
        {
            ...
            motionMgr.SetServoON((ushort)Axislist.Mod1ZAxis, true);//20171216
            motionMgr.SetServoON((ushort)Axislist.Mod2ZAxis, true);
            Thread.Sleep(100);
        ...
        private void NDFilterCheckBtn_Click(object sender, EventArgs e)
        {
            ...
            if (motionMgr.ReadIOIn(1,(ushort)InputIOlist.SafetySensor))
            {
